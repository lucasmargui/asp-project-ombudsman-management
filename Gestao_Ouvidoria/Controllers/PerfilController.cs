...
namespace Gestao_Ouvidoria.Controllers
{
    public class PerfilController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Email,Telefone,Celular,TipoPerfil")] Perfil perfil)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Email,Telefone,Celular,TipoPerfil")] Perfil perfil)
        {
            if (ModelState.IsValid)
            {
